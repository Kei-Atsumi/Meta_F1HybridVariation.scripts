...
# load spLS files
dat.modif <- read.table("../data/sexual.dat.modif.csv", head = TRUE, sep = "\t")
dat.modif.copy <- read.table("../data/sexual.dat.modif.csv", head = TRUE, sep = "\t")
```
...
write.table(Recip, "../data/sexual.ES.recip.csv", 
            row.names = F, sep = "\t")
...
write.table(mat.pat2, "../data/sexual.ES.matpat.csv", 
            row.names = F, sep = "\t")
...
write.table(epistasis, "../data/sexual.ES.epistasis.csv", 
            row.names = F, sep = "\t")

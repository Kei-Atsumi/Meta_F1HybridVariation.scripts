...
print("percent larger in hybrids compared to midparent")
(exp(summary(midparent.random)$beta))*100 - 100

```

Dominance for the greater phenotype was shown. Both hybrids (LS & SL) were greater than midparent in 1.5 or 1.2 percent

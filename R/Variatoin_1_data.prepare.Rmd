---
title: "Variation Step1.data.preparation"
...
pheno <- read.xlsx(
  ...
  ### Calculate phenotypic divergence between parental species ###
  mutate(
    # Difference
  ...
  # delete observations with negative mean trait value
  ...
  mutate(
    reciprocal = ifelse(
      is.na(Mn.hyb12), "Inviable",
      ifelse(
        is.na(Mn.hyb21), "Inviable", "Viable"
        )
      )
    )
...
####################################################
# modify sp1 & sp2 -> spL & spS according to the CV
####################################################
...
############ export ############
write.csv(LS,"../data/dat.CV.csv", quote=F,row.names = F)

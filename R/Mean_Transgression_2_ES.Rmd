  ...
  for (h in c("hybLS", "hybSL")) { # identify type of parentals
    assign(
      ...
      left_join(
        ...
        mutate(direction = "Greater") # indicate direction of transgressive segregation - larger or smaller
    )
  }
}
  ...
  for (h in c("spS")) { # identify type of parentals
    assign(
      ...
      left_join(
        ...
        select(ES.ID, contains("lnRR"), contains("SMD")) %>%
        mutate(direction = "Smaller") # indicate direction of transgressive segregation - larger or smaller
    )
  }
}

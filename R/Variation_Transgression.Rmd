...
# phylmix$Sol <- phylmix$Sol/sqrt(1+c2)
# ### Save model ###
# saveRDS(phylmix, file ="../Analysis/Variation.transgression.divergence.COI.obj")
# 
# # +++++++++++++++++++++++++++++++++++++++++++#
...
# phylmix$Sol <- phylmix$Sol/sqrt(1+c2)
# ### Save model ###
# saveRDS(phylmix, file ="../Analysis/Variation.transgression.pheno.div.ratio.obj")
...
for (i in c("divergence.COI", "pheno.div.ratio")) {
  ...
  ### Load model ###
  phylmix <- readRDS(
    paste("../Analysis/Variation.transgression",i, "obj", sep = ".")
    )

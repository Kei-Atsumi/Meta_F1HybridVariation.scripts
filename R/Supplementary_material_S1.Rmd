...
print(metaplot)
  ...
  sum %>% 
    ...
    kable("html", caption = paste("Fixed effects estimates:", taxon, "data", " ")) %>% 
    kable_styling("striped", position = "left") %>%
    scroll_box(width = "100%", height = "500px") %>%
    print()
...
# Novelty in phenotypic variabilities (using lnVR)

## Frequency

```{r}

dat.full <- read.csv("../data/lnVR.ES.Novelty.csv", head = TRUE)
...
for (taxon in c("alltaxon", "insect")) {
  ...
  # saveRDS(
  #   phylmix,
  #   file = paste("../Analysis/lnVR.novelty.allfactors", taxon, "obj", sep = ".")
  #   )
  
  ## Load model ###
  phylmix <- readRDS(file = paste("../Analysis/lnVR.novelty.allfactors", taxon, "obj", sep = "."))

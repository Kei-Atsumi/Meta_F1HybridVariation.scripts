...
prior<-list(B=list(mu = rep(0, 10),  V=gelman.prior(~ 
    divergence.COI + sq.divergence.COI + trait.type + pheno.div.diff + hetero.sex + distribution + parental + direction + reciprocal, data=TS, scale=sqrt(pi^2/3+1))),
             R=list(V=1,fix=1),

...
prior <- list(
  B=list(mu = rep(0, 16), # N of coefficient. (level -1) for categorical factors, 1 for continuous factors  
...
phylmix <-MCMCglmm(
  fixed = TS ~ 
    direction + divergence.COI + sq.divergence.COI + pheno.div.ratio + parental + trait.type + distribution + reciprocal +
    direction*divergence.COI + direction*sq.divergence.COI +     direction*pheno.div.ratio + direction*parental + direction*trait.type + direction*distribution + direction*reciprocal,

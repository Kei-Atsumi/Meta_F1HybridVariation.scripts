...
<<<<<<< HEAD
  openxlsx,   # open excel
=======
>>>>>>> 7608b28a2b9882ce01e9d34fa88b52788b9e7bb5
  tidyverse,  
  MCMCglmm,   # glmm
  knitr,      # rmarkdown
...
<<<<<<< HEAD
  within(group <- ordered(group, c("transgressive segregation", "increasing variation", "exceed mother species"))) %>%
=======

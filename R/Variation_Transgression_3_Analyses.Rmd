...
```{r Direct test for the significant categorical factors, include=FALSE}
...
for (i in c("reciprocal", "trait.type")) {
  ...
  ggsave(
      ...
      file = 
        paste("../Analysis/variation.TS.categorical", i, "svg", sep = "."),
      height = 4, width = 5
      )
  ...
  a <- bind_rows(
    ...
    mutate_at(vars("lower", "upper"), round, 3)
  print(a)

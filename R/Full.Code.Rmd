...
In quantifying dominance mismatch, we calculated d<sub>mismatch</sub> following [Thompson 2019](https://www.biorxiv.org/content/10.1101/818658v1.full#disp-formula-1). d<sub>mismatch</sub> was calculated as follows:
...
$Z_i$ is 0-1 if not transgressed. But, $Z_i$ is sensitive to absolute trait size: when trait size is large and parental phenotypic divergence is small, transgressive hybrid phenotype will result in quite large $Z_i$. This seems occurred in mice (see bellow) <br>
...
dat %>% 
  ...
  kable("html", caption = "Dataset") %>% kable_styling("striped", position = "left")
...
ggplot(
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  facet_grid(~taxa, scales = "free") +
  ggtitle("dmismatch excluding Rodentia")

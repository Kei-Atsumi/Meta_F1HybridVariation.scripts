...
__Study.ID__: ID of studies

__Study.name__: Including author name(s) and published year

__Source__: Source of phenotypc data in the primary studes

__Cross.ID__: Parental species used in the crossing expreiments. Distinguishes intraspecific populations.

__Gennus__: Studied genus
...
* `spL.name`: Phylogeny of parental species (<i>spLL</i>)

---
title: "Variation Trangression 2 ES calculation"
  ...
  for (h in c("hybLS", "hybSL")) { # identify type of parentals
    assign(
      paste(h, i, sep = "_"),
        ...
        select(ES.ID, yi, vi) %>%
        # indicate direction of overdominance - toward spL or spS
        mutate(direction = "+")
    )
  }
}
...
ggsave(plot = plot, file = "../Analysis/dat.variation.TS.svg", height = 5, width = 3.5)
...
write.tree(
  bin.tree, 
  file= "../data/phylo.variation.TS.tre"
  )
